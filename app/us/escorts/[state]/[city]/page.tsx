  ...
  useEffect(() => {
    ...
    if (stateNameValue) {
      ...
      if (cityNameValue) {
        ...
        // Filter ads for this city and state
        const cityAds = sampleAds.filter(ad => 
          ad.location.stateAbbreviation === stateAbbr && 
          ad.location.city.toLowerCase().replace(/\s+/g, '-') === params.city.toLowerCase()
        )

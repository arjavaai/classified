...
export default function DisplayAndAdPricePage() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen relative">
      ...
      <div className="bg-[#007bff] text-white py-6 w-full">
        <div className="container mx-auto text-center">
          <h1 className="text-3xl font-bold">Display & Ad Price</h1>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
          ...
          >
            <div className="p-6">
              ...
              <ul className="space-y-2 mb-6">
                ...
                <li className="flex items-start">
                  <span className="text-gray-500 mr-2">•</span>
                  <span className="text-gray-600">One ad per 24hr.</span>
                </li>
                <li className="flex items-start">
                  <span className="text-gray-500 mr-2">•</span>
                  <span className="text-gray-600">Repost after 24hr.</span>
                </li>
                <li className="flex items-start">
                  <span className="text-gray-500 mr-2">•</span>
                  <span className="text-gray-600">Each add will expire after 24hr.</span>
                </li>
                <li className="flex items-start">
                  <span className="text-gray-500 mr-2">•</span>
        ...
        <div className="mt-8">
          {/* Error notification */}
          {showError && (
            <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-md flex items-center justify-center mb-4">
              <AlertCircle className="h-5 w-5 mr-2 flex-shrink-0" />
              <span>Please select an ad type to continue</span>
            </div>
          )}
          
          {/* Create Ad button centered */}
